...
int main() {
  ...
  title("Testing cslib::any_error and cslib_throw_up"); {
    std::ostringstream shouldBeWhat; // e.what()
    shouldBeWhat << "cslib::any_error called in workspace " << std::filesystem::current_path() << ' ';
    shouldBeWhat << "on line " << __LINE__ + 2 << " in function \"" << "int main()" << "\" because: "; // throw_up is called 2 lines beneath
  ...
  //   const char *const args1[] = {"program", "arg1", "arg2", "arg3"};
  ...
  //   const char *const args2[] = {"program"};
